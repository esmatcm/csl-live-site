...
# ULTRA FUZZY DICTIONARY
I18N_TC = {
    "Man City": "曼城", "City": "曼城", "Liverpool": "利物浦", "Arsenal": "阿森納",
    "Real Madrid": "皇家馬德里", "Madrid": "皇馬", "Barcelona": "巴塞隆納", "Barca": "巴薩",
    "Bayern": "拜仁慕尼黑", "Munich": "慕尼黑", "Inter": "國際米蘭", "Milan": "AC米蘭",
    "Juventus": "尤文圖斯", "Juve": "尤文", "PSG": "巴黎聖日耳門", "Paris": "巴黎",
    "Chelsea": "切爾西", "Man Utd": "曼聯", "United": "曼聯", "Tottenham": "熱刺", "Spurs": "熱刺",
    "Newcastle": "紐卡斯爾聯", "Villa": "阿斯頓維拉", "West Ham": "西漢姆聯", "Everton": "艾弗頓",
    "Wolves": "狼隊", "Brighton": "布萊頓", "Fulham": "富勒姆", "Brentford": "布倫特福德",
    "Palace": "水晶宮", "Forest": "諾丁漢森林", "Bournemouth": "伯恩茅斯", "Luton": "卢顿",
    "Burnley": "伯恩利", "Sheffield": "謝菲爾德", "Girona": "赫羅納", "Sociedad": "皇家社會",
    "Betis": "貝蒂斯", "Athletic": "畢爾包", "Bilbao": "畢爾包", "Valencia": "瓦倫西亞",
    "Villarreal": "比利亚雷亚尔", "Sevilla": "塞維利亞", "Lyon": "里昂", "Marseille": "馬賽",
    "Monaco": "摩納哥", "Lille": "里爾", "Nice": "尼斯", "Lens": "朗斯", "Rennes": "雷恩",
    "Benfica": "本菲卡", "Sporting": "葡萄牙體育", "Porto": "波爾圖", "Ajax": "阿賈克斯",
    "PSV": "PSV埃因霍溫", "Feyenoord": "費耶諾德", "Galatasaray": "加拉塔薩雷",
    "Fenerbahce": "費內巴切", "Celtic": "凱爾特人", "Rangers": "流浪者", "Brugge": "布魯日",
    "Union SG": "聖吉羅斯", "Oviedo": "奧維耶多", "Hoffenheim": "霍芬海姆", "Frankfurt": "法蘭克福",
    "Leipzig": "萊比錫", "Bremen": "不萊梅", "Augsburg": "奧格斯堡", "Leeds": "里茲聯",
    "Osasuna": "奧薩蘇納", "Napoli": "拿坡里", "HSV": "漢堡", "Hamburg": "漢堡",
    "Levante": "萊萬特", "Lorient": "洛里昂", "Cagliari": "卡利亞里", "Elche": "埃爾切",
    "Pisa": "比薩", "Como": "科莫", "Parma": "帕爾馬", "Venezia": "威尼斯", "Cremonese": "克雷莫納",
    "Sampdoria": "桑普多利亞", "Heidenheim": "海登海姆", "Darmstadt": "達姆施塔特",
    "Bochum": "波鴻", "Mainz": "美因茨", "St. Pauli": "聖保利", "Kiel": "基爾",
    "Stuttgart": "斯圖加特", "Freiburg": "弗賴堡", "Gladbach": "門興", "Berlin": "柏林聯",
    "Wolfsburg": "沃爾夫斯堡", "Dusseldorf": "杜塞爾多夫", "Paderborn": "帕德博恩",
    "Karlsruhe": "卡爾斯魯厄", "Hertha": "柏林赫塔", "Greuther": "菲爾特", "Elversberg": "埃爾弗斯貝格",
    "Magdeburg": "馬格德堡", "Nurnberg": "紐倫堡", "Schalke": "沙爾克04", "Kaiserslautern": "凱澤斯劳滕",
    "Wehen": "韋恩", "Rostock": "羅斯托克", "Braunschweig": "布倫瑞克", "Osnabrück": "奧斯納布呂克",
    "Salernitana": "薩勒尼塔納", "Frosinone": "弗羅西諾內", "Sassuolo": "薩索洛", "Udinese": "烏迪內斯",
    "Empoli": "恩波利", "Verona": "維羅納", "Lecce": "萊切", "Genoa": "熱那亞", "Monza": "蒙扎",
    "Torino": "都靈", "Lazio": "拉齊奧", "Roma": "羅馬", "Bologna": "博洛尼亞",
    "Fiorentina": "佛羅倫薩", "Atalanta": "亞特蘭大", "Southampton": "南安普頓",
    "Leicester": "萊斯特城", "Ipswich": "伊普斯維奇", "Zhibo8": "直播吧", "88Kanqiu": "88看球",
    "Google": "Google搜尋"
}
...
def get_trilingual(text_en):
    ...
    if text_en in I18N_TC: tc = I18N_TC[text_en]
        ...
        # 2. Fuzzy Containment (The "Killer" Feature)
        for k, v in I18N_TC.items():
            if k in text_en: # If "Stuttgart" in "VfB Stuttgart 1893"
                tc = v
                break
...
def run():
    ...
    for m in matches:
        ...
        # FIX STREAMS: Use Google Search as fallback
        if status in ['IN_PLAY', 'TIMED', 'SCHEDULED']:
            item['streams'] = [
                ...
                {"name": {"en": "Google Search", "tc": "Google 搜尋", "sc": "Google 搜索"}, "url": f"https://www.google.com/search?q={item['home']['tc']}+直播"}
            ]

        data_all.append(item)

    final_json = { "matches": data_all, "standings": DATA_CACHE['standings'] }
