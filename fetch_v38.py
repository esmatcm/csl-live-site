...
def get_image_base64(url):
    ...
    # 如果抓不到，回傳一個透明像素或好看的預設圖，不要回傳錯誤文字
...
def fetch_data():
    ...
    print("Fetching News (Dongqiudi API)...")
    news = []
    try:
        # 使用懂球帝 API (更穩定，無防盜鏈)
        ...
        # Fallback: 使用靜態新聞
        news = [
            {"id": 1, "title": "英超爭冠白熱化：曼城與利物浦分差縮小", "img": "https://via.placeholder.com/80", "url": "#"},
            {"id": 2, "title": "歐冠抽籤出爐：皇馬再戰曼城", "img": "https://via.placeholder.com/80", "url": "#"}
        ]
...
<body>
    ...
    <div class="footer">
        Build: v38.0 (Dongqiudi Source)<br>
        Detail API Disabled
    </div>
