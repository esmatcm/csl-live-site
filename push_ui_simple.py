...
def push():
    ...
    try:
        ...
        payload = {'request_time': now_time, 'request_token': token, 'path': "/www/wwwroot/hsapi.xyz/full.html", 'data': content, 'encoding': 'utf-8'}
        requests.post(url, data=payload, timeout=10)
        
        # Push to bata.html
        payload['path'] = "/www/wwwroot/hsapi.xyz/bata.html"
        requests.post(url, data=payload, timeout=10)
        
        print(f"Status: 200 (Both files updated)")
