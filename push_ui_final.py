...
def push():
    print("Pushing FINAL UI...")
    try:
        with open('csl-live-site/index_final.html', 'r', encoding='utf-8') as f:
            content = f.read()
        ...
        print(f"Prod: {r.status_code}")
        
        # Push to Full
        payload['path'] = "/www/wwwroot/hsapi.xyz/full.html"
