...
# ULTRA DICTIONARY v53
I18N = {
    "teams": {
        # --- England (PL, Championship, League 1/2) ---
        "Man City": "曼城", "Manchester City": "曼城", "Liverpool": "利物浦", "Arsenal": "阿森納",
        "Chelsea": "切爾西", "Man United": "曼聯", "Man Utd": "曼聯", "Tottenham": "熱刺",
        "Newcastle": "紐卡斯爾聯", "Aston Villa": "阿斯頓維拉", "West Ham": "西漢姆聯",
        "Everton": "艾弗頓", "Wolves": "狼隊", "Brighton": "布萊頓", "Fulham": "富勒姆",
        "Brentford": "布倫特福德", "Crystal Palace": "水晶宮", "Nottm Forest": "諾丁漢森林",
        "Bournemouth": "伯恩茅斯", "Luton": "卢顿", "Burnley": "伯恩利", "Sheff Utd": "謝菲爾德聯",
        "Sheffield Utd": "謝菲爾德聯", "Sheffield Wed": "謝菲爾德星期三", "Leeds": "里茲聯",
        "Leicester": "萊斯特城", "Southampton": "南安普頓", "Ipswich": "伊普斯維奇",
        "Norwich": "諾維奇", "West Brom": "西布朗", "Hull City": "赫爾城", "Coventry": "考文垂",
        "Preston": "普雷斯頓", "Middlesbrough": "米德尔斯堡", "Cardiff": "卡迪夫城",
        "Sunderland": "桑德蘭", "Bristol City": "布里斯托城", "Swansea": "斯旺西",
        "Watford": "沃特福德", "Millwall": "米爾沃爾", "Stoke": "斯托克城", "QPR": "女王公園巡遊者",
        "Blackburn": "布萊克本", "Plymouth": "普利茅斯", "Birmingham": "伯明翰",
        "Huddersfield": "哈德斯菲爾德", "Rotherham": "羅瑟勒姆", "Derby": "德比郡",
        "Portsmouth": "樸茨茅斯", "Bolton": "博爾頓", "Peterborough": "彼得堡聯",
        "Oxford Utd": "牛津聯", "Wrexham": "雷克斯漢姆", "Stockport": "斯托克波特",
        "Mansfield": "曼斯菲爾德", "Barrow": "巴羅", "Crewe": "克魯", "MK Dons": "米爾頓凱恩斯",
        "AFC Wimbledon": "溫布頓", "Walsall": "沃爾索爾", "Crawley": "克勞利",
        "Bradford": "布拉德福德", "Gillingham": "吉林漢姆", "Harrogate": "哈羅蓋特",
        "Notts County": "諾茨郡", "Accrington": "阿克寧頓", "Swindon": "斯溫頓",
        "Salford": "沙福特城", "Morecambe": "莫克姆", "Doncaster": "唐卡斯特",
        "Tranmere": "特蘭米爾", "Grimsby": "格林斯比", "Colchester": "科爾切斯特",
        "Sutton": "薩頓聯", "Forest Green": "格林森林流浪", "Blackpool": "布萊克浦",
        "Barnsley": "巴恩斯利", "Lincoln": "林肯城", "Stevenage": "史蒂夫尼奇",
        "Leyton Orient": "萊頓東方", "Northampton": "北安普頓", "Exeter": "埃克塞特",
        "Wigan": "維岡", "Wycombe": "威科姆", "Bristol Rovers": "布里斯托流浪",
        "Cambridge": "劍橋聯", "Reading": "雷丁", "Shrewsbury": "舒茲伯利",
        "Charlton": "查爾頓", "Port Vale": "維爾港", "Fleetwood": "弗利特伍德",
        "Carlisle": "卡素爾", "Cheltenham": "切爾滕納姆",
        
        # --- Spain (La Liga & Segunda) ---
        "Real Madrid": "皇家馬德里", "Barcelona": "巴塞隆納", "Barça": "巴塞隆納",
        "Girona": "赫羅納", "Atletico": "馬德里競技", "Atleti": "馬德里競技",
        "Athletic Club": "畢爾包", "Athletic": "畢爾包", "Real Sociedad": "皇家社會",
        "Betis": "貝蒂斯", "Valencia": "瓦倫西亞", "Villarreal": "比利亚雷亚尔",
        "Getafe": "赫塔費", "Las Palmas": "拉斯帕爾馬斯", "Alavés": "阿拉維斯",
        "Osasuna": "奧薩蘇納", "Rayo Vallecano": "巴列卡諾", "Mallorca": "馬略卡",
        "Sevilla": "塞維利亞", "Celta": "塞爾塔", "Cadiz": "加的斯", "Granada": "格拉納達",
        "Almeria": "阿爾梅里亞", "Leganés": "雷加利斯", "Espanyol": "西班牙人",
        "Valladolid": "瓦拉多利德", "Eibar": "埃瓦爾", "Sporting Gijon": "希洪體育",
        "Real Oviedo": "奧維耶多", "Racing Santander": "桑坦德競技", "Elche": "埃爾切",
        "Levante": "萊萬特", "Burgos": "布爾戈斯", "Racing Ferrol": "費羅爾競技",
        "Tenerife": "特內里費", "Albacete": "阿爾瓦塞特", "Zaragoza": "薩拉戈薩",
        "Eldense": "埃爾登塞", "Huesca": "韋斯卡", "Mirandes": "米蘭德斯",
        "Cartagena": "卡塔赫納", "Alcorcon": "阿爾科爾孔", "Andorra": "安道爾",
        "Villarreal B": "比利亞雷亞爾B", "Amorebieta": "阿莫雷比耶塔",
        
        # --- Germany (Bundesliga 1 & 2) ---
        "Leverkusen": "勒沃庫森", "Bayern": "拜仁慕尼黑", "Bayern Munich": "拜仁慕尼黑",
        "Stuttgart": "斯圖加特", "Dortmund": "多特蒙德", "Leipzig": "萊比錫",
        "Frankfurt": "法蘭克福", "Hoffenheim": "霍芬海姆", "Freiburg": "弗賴堡",
        "Heidenheim": "海登海姆", "Augsburg": "奧格斯堡", "Werder": "不萊梅",
        "Wolfsburg": "沃爾夫斯堡", "Gladbach": "門興", "M'gladbach": "門興",
        "Union Berlin": "柏林聯", "Bochum": "波鴻", "Mainz": "美因茨", "Köln": "科隆",
        "Darmstadt": "達姆施塔特", "St. Pauli": "聖保利", "Holstein Kiel": "基爾",
        "Dusseldorf": "杜塞爾多夫", "HSV": "漢堡", "Hamburg": "漢堡",
        "Hannover": "漢諾威96", "Paderborn": "帕德博恩", "Karlsruhe": "卡爾斯魯厄",
        ...
        "Braunschweig": "布倫瑞克", "Osnabrück": "奧斯納布呂克",
        
        # --- Italy (Serie A & B) ---
        "Inter": "國際米蘭", "Milan": "AC米蘭", "Juventus": "尤文圖斯", "Bologna": "博洛尼亞",
        "Roma": "羅馬", "Atalanta": "亞特蘭大", "Napoli": "拿坡里", "Fiorentina": "佛羅倫薩",
        "Lazio": "拉齊奧", "Torino": "都靈", "Monza": "蒙扎", "Genoa": "熱那亞",
        "Lecce": "萊切", "Udinese": "烏迪內斯", "Empoli": "恩波利", "Verona": "維羅納",
        "Cagliari": "卡利亞里", "Frosinone": "弗羅西諾內", "Sassuolo": "薩索洛",
        "Salernitana": "薩勒尼塔納", "Parma": "帕爾馬", "Como": "科莫", "Venezia": "威尼斯",
        "Cremonese": "克雷莫納", "Catanzaro": "卡坦扎羅", "Palermo": "巴勒莫",
        "Sampdoria": "桑普多利亞", "Brescia": "布雷西亞", "Sudtirol": "南蒂羅爾",
        "Cittadella": "奇塔代拉", "Pisa": "比薩", "Reggiana": "雷吉亞納",
        "Modena": "摩德納", "Cosenza": "科森扎", "Bari": "巴里", "Spezia": "斯佩齊亞",
        "Ascoli": "阿斯科利", "Ternana": "特爾納納", "Feralpisalo": "費拉爾皮沙洛",
        "Lecco": "萊科",
        
        # --- France (Ligue 1 & 2) ---
        "PSG": "巴黎聖日耳門", "Paris SG": "巴黎聖日耳門", "Monaco": "摩納哥",
        "Brest": "布雷斯特", "Lille": "里爾", "Nice": "尼斯", "Lens": "朗斯",
        "Marseille": "馬賽", "Lyon": "里昂", "Rennes": "雷恩", "Reims": "蘭斯",
        "Toulouse": "圖盧茲", "Strasbourg": "斯特拉斯堡", "Montpellier": "蒙彼利埃",
        "Nantes": "南特", "Le Havre": "勒阿弗爾", "Metz": "梅斯", "Lorient": "洛里昂",
        "Clermont": "克萊蒙", "Auxerre": "歐塞尔", "Angers": "昂熱", "St Etienne": "聖埃蒂安",
        "Rodez": "羅德茲", "Paris FC": "巴黎FC", "Caen": "卡昂", "Laval": "拉瓦勒",
        "Guingamp": "甘岡", "Pau": "波城", "Grenoble": "格勒諾布爾", "Bastia": "巴斯蒂亞",
        "Amiens": "亞眠", "Ajaccio": "阿雅克肖", "Dunkerque": "登克爾克",
        "Bordeaux": "波爾多", "Annecy": "安錫", "Troyes": "特魯瓦",
        "Concarneau": "孔卡爾諾", "Quevilly": "克維伊", "Valenciennes": "瓦朗謝訥",
        
        # --- Rest of World (Turkey, Netherlands, Portugal, etc.) ---
        "Galatasaray": "加拉塔薩雷", "Fenerbahce": "費內巴切", "Besiktas": "貝西克塔斯",
        "Trabzonspor": "特拉布宗", "PSV": "PSV埃因霍溫", "Feyenoord": "費耶諾德",
        "Twente": "特溫特", "AZ": "阿爾克馬爾", "Ajax": "阿賈克斯", "Sporting CP": "葡萄牙體育",
        "Benfica": "本菲卡", "Porto": "波爾圖", "Braga": "布拉加", "Vitoria": "吉馬良斯",
        "Celtic": "凱爾特人", "Rangers": "流浪者", "Young Boys": "年輕人", "Servette": "塞爾維特",
        "Lugano": "盧加諾", "Zurich": "蘇黎世", "Winterthur": "溫特圖爾", "Salzburg": "薩爾茨堡",
        "Sturm Graz": "格拉茨風暴", "LASK": "林茨", "Rapid Wien": "維也納迅速",
        ...
        "Antwerp": "安特衛普", "Genk": "亨克", "Gent": "根特", "Copenhagen": "哥本哈根",
        "Midtjylland": "中日德蘭", "Brondby": "布隆德比", "Malmo": "馬爾默",
        "Bodo/Glimt": "博多格林特", "Molde": "莫爾德", "Sparta Praha": "布拉格斯巴達",
        "Slavia Praha": "布拉格斯拉維亞", "Plzen": "比爾森", "Ferencvaros": "費倫茨瓦羅斯",
        "Dinamo Zagreb": "薩格勒布戴拿模", "Crvena Zvezda": "紅星", "Partizan": "游擊隊"
    },
    "status": {
