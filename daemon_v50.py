...
I18N = {
    "teams": {
        ...
        "Ipswich Town": "伊普斯維奇", "Leicester City": "萊斯特城", "Southampton": "南安普頓",
        "Leeds United": "里茲聯",
        # Spain
        "Girona": "赫羅納", "Real Sociedad": "皇家社會", "Betis": "貝蒂斯",
        "Athletic Club": "畢爾包", "Athletic": "畢爾包", "Valencia": "瓦倫西亞", 
        ...
        "Bologna": "博洛尼亞", "Fiorentina": "佛羅倫薩", "Torino": "都靈",
        "Monza": "蒙扎", "Genoa": "熱那亞", "Udinese": "烏迪內斯", "Lecce": "萊切",
        "Empoli": "恩波利", "Verona": "維羅納", "Cagliari": "卡利亞里",
        "Parma": "帕爾馬", "Como": "科莫", "Venezia": "威尼斯",
        # Germany
        "Leverkusen": "勒沃庫森", "Dortmund": "多特蒙德", "Leipzig": "萊比錫",
        ...
        "Union Berlin": "柏林聯", "Bochum": "波鴻", "Mainz": "美因茨",
        "St. Pauli": "聖保利", "Holstein Kiel": "基爾",
        # France
        "Lyon": "里昂", "Marseille": "馬賽", "Monaco": "摩納哥", "Brest": "布雷斯特",
        "Lille": "里爾", "Lens": "朗斯", "Rennes": "雷恩", "Nice": "尼斯",
        "Reims": "蘭斯", "Toulouse": "圖盧茲", "Montpellier": "蒙彼利埃",
        "Strasbourg": "斯特拉斯堡", "Nantes": "南特", "Le Havre": "勒阿弗爾",
        "Auxerre": "歐塞尔", "Angers": "昂熱", "Saint-Étienne": "聖埃蒂安",
        # CL & Others
        "Sporting CP": "葡萄牙體育", "Benfica": "本菲卡", "Porto": "波爾圖",
        "PSV": "PSV埃因霍溫", "Feyenoord": "費耶諾德", "Celtic": "凱爾特人",
